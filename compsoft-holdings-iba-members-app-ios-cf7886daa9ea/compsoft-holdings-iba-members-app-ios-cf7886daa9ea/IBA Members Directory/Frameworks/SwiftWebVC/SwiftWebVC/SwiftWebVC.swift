...
public class SwiftWebVC: UIViewController {
    ...
    func updateToolbarItems() {
        ...
        if (UIDevice.current.userInterfaceIdiom == UIUserInterfaceIdiom.pad) {
            ...
            let items: NSArray = [fixedSpace, refreshStopBarButtonItem, fixedSpace, backBarButtonItem, fixedSpace, forwardBarButtonItem, fixedSpace, actionBarButtonItem,fixedSpace,closeBarButtonItem]
            ...
            let items: NSArray = [fixedSpace, backBarButtonItem, flexibleSpace, forwardBarButtonItem, flexibleSpace, refreshStopBarButtonItem, flexibleSpace, actionBarButtonItem, flexibleSpace, closeBarButtonItem,fixedSpace]
